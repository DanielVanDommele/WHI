...
var _PresenceController_instances, _PresenceController_baseUrl, _PresenceController_persist, _PresenceController_getPersonPresences, _PresenceController_addPresence, _PresenceController_addPersonToPresence, _PresenceController_updatePresence, _PresenceController_removePersonFromPresence, _PresenceController_deletePresence;
...
class PresenceController extends ControllerBase_1.default {
    ...
    setup() {
        this.getApp().get(`${__classPrivateFieldGet(this, _PresenceController_baseUrl, "f")}/:personId`, __classPrivateFieldGet(this, _PresenceController_instances, "m", _PresenceController_getPersonPresences));
        this.getApp().post(`${__classPrivateFieldGet(this, _PresenceController_baseUrl, "f")}/:personId`, __classPrivateFieldGet(this, _PresenceController_instances, "m", _PresenceController_addPresence));
        this.getApp().post(`${__classPrivateFieldGet(this, _PresenceController_baseUrl, "f")}/:presenceId/plus/:personId`, __classPrivateFieldGet(this, _PresenceController_instances, "m", _PresenceController_addPersonToPresence));
        this.getApp().put(`${__classPrivateFieldGet(this, _PresenceController_baseUrl, "f")}`, __classPrivateFieldGet(this, _PresenceController_instances, "m", _PresenceController_updatePresence));
        this.getApp().delete(`${__classPrivateFieldGet(this, _PresenceController_baseUrl, "f")}/:presenceId/minus/:personId`, __classPrivateFieldGet(this, _PresenceController_instances, "m", _PresenceController_removePersonFromPresence));
        this.getApp().delete(`${__classPrivateFieldGet(this, _PresenceController_baseUrl, "f")}/:personId`, __classPrivateFieldGet(this, _PresenceController_instances, "m", _PresenceController_deletePresence));
    }
...
_PresenceController_baseUrl = new WeakMap(), _PresenceController_persist = new WeakMap(), _PresenceController_instances = new WeakSet(), _PresenceController_getPersonPresences = function _PresenceController_getPersonPresences(req, res) {
    ...
    const presence = req.body;
    const validator = () => this.validateId(personId) && this.validatePresence(presence);
    const operation = () => __classPrivateFieldGet(this, _PresenceController_persist, "f").deletePresence(presence, personId);
    this.handleRestCall(req, res, validator, operation);
};

...
class PersonController extends ControllerBase_1.default {
    ...
    setup() {
        ...
        this.getApp().get(`${__classPrivateFieldGet(this, _PersonController_baseUrl, "f")}/relations/:relationType/:id`, __classPrivateFieldGet(this, _PersonController_instances, "m", _PersonController_getPersonSpecificRelations));
        this.getApp().post(`${__classPrivateFieldGet(this, _PersonController_baseUrl, "f")}`, __classPrivateFieldGet(this, _PersonController_instances, "m", _PersonController_addPerson));
        this.getApp().post(`${__classPrivateFieldGet(this, _PersonController_baseUrl, "f")}/relations/:id`, __classPrivateFieldGet(this, _PersonController_instances, "m", _PersonController_addPersonRelation));
        this.getApp().put(`${__classPrivateFieldGet(this, _PersonController_baseUrl, "f")}`, __classPrivateFieldGet(this, _PersonController_instances, "m", _PersonController_updatePerson));
        this.getApp().delete(`${__classPrivateFieldGet(this, _PersonController_baseUrl, "f")}/:id`, __classPrivateFieldGet(this, _PersonController_instances, "m", _PersonController_deletePerson));
        this.getApp().delete(`${__classPrivateFieldGet(this, _PersonController_baseUrl, "f")}/relations/:id1/:id2`, __classPrivateFieldGet(this, _PersonController_instances, "m", _PersonController_deletePersonRelation));
    }
}
